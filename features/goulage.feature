...
Given Se abre el juego
Then Muestra el tableroA "A _ _ _ _ _ _"
Then Muestra el tableroB "B _ _ _ _ _ _"

Scenario: Inicia el juego, juega A muestra tablero A
Given Se abre el juego
When Jugador A tira 3
Then Muestra el tableroA "_ _ _ A _ _ _"
...
Then Muestra el tableroA "_ _ _ A _ _ _"
Then Muestra el tableroB "_ _ _ _ B _ _"
